...
Data analyst who speaks both SQL and boardroom. I build the dashboards leaders trust and the models that tell them why.
...
- 🌊 **[iHARP ML Challenge](https://github.com/harshithajosyula3112/Coastal-Flooding-Prediction)** - End-to-end forecasting pipeline using LSTM and XGBoost on NOAA coastal flooding data
- 🎬 **[Hybrid Netflix Recommendation Engine](https://github.com/harshithajosyula3112/Netflix-Recommendation-System)** - Content-based recommendation system with 65% similarity accuracy, live Streamlit app
